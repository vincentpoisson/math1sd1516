...
%\headheight 15.0 pt
\fancyhead[L]{Introduction à GitHub}
...
\begin{document}
  ...
  \begin{enumerate}
   \item Aller sur le site www.github.com.
   \item Rechercher un dépôt contenant la chaîne math1sd.
   \item Parcourir les dépôts GitHub de l'utilisateur mathlorgues.
   \item Créer une demande (issue) sur le dépôt math1d1516.
   \item Créer un compte en faisant l'un des deux choix suivants
   \begin{enumerate}
     \item utiliser l'identifiant formé comme suit.prénomNom.
     \item utiliser un pseudo et envoyer alors un mail à mathlorgues@netcourrier.com
     en indiquant prénom nom nom d'utilisateur GitHub. 
   \end{enumerate}
   \item Créer un dépôt au nom de votre choix. 
   Attention à bien cocher la case pour la création du fichier d’accueil:
   ``Initialize this repository with a README ``
   \item Réaliser vos propres expérimentations.
  \end{enumerate}
