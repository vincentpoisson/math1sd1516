...
%\headheight 15.0 pt
\fancyhead[L]{}
\fancyhead[C]{Guide d'utilisation de GitHub}
\fancyhead[R]{ \today}
...
\begin{document}
  ...
  \section{Consultation d'un dépot public.}
  
  \begin{enumerate}
   \item Rendez-vous sur la page d'acceuil de 
  \href{https://github.com/}
  {GitHub.} 
  
  \includegraphics[width=18cm]{AcceuilGitHub}

  \item En utilisant la barre de recherche GitHub, vous pouvez réalisez une recherche.
  En particulier,d'un dépot ou d'un utilicontenant les caractères 1sd.
  
  \includegraphics[width=18cm]{resultatRechercheDepot}
  \item Vous devriez trouver, parmi les propositions, le dépot math1sd1516 réalisé par l'utilisateur
  mathlorgues.
  
  \item En empruntant le lien sur la gauche nommé users vous pourrez réaliser 
