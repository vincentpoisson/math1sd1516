...
\fancyhead[C]{ Séance du 4 septembre 2015}
%\fancyhead[R]{ \today}
...
\begin{document}
  ...
  \begin{enumerate}
   ...
   \item Factorisations: ex 1 p 22.
   \item Variations d'un trinôme du second degré: Activité 2 1. 2.
   
   \item Intersections de paraboles avec l'axe des abscisses.
   \begin{enumerate}
    \item Activité 1 3.-8.
    \item Proposition 1. Positions de paraboles.
    \item Terminologie: Racines d'un trinôme.
   \end{enumerate}
