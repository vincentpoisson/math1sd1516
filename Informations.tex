...
\begin{document}
  ...
  \begin{enumerate}
   \item Adresse mail de l'enseignant: mathlorgues@netcourrier.com/ 
   \item Vous trouverez tous les documents utilisés pour les séances sur
  service web d'hébergement et de gestion de développement de logiciels GitHub 
  (utilisant le logiciel de gestion de versions Git.)
  
  
  https://github.com/mathlorgues/math1sd1516
