...
\fancyhead[R]{Lundi 8 septembre 2015}
...
\begin{document}
  ...
  \begin{Theo}[Central]
    ...
    \begin{itemize}
     ...
     \item $f(x)$ admet une racine double $\alpha$ si et seulement si
     $\beta=0$.
...
\begin{Rq}
   On déduit de ce théorème qu'un trinome du second degré ne possède pas de racine si
   et seulement si son discriminant est strictement négatif.
   
   Si tel est le cas, ce trinome ne peut se factoriser en un produit de termes de degré 1.
  \end{Rq}
