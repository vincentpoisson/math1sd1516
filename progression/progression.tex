...
\begin{document}
  ...
  \begin{Seq}
    ...
    \begin{itemize}
      ...
      $\to$    
      \href{https://github.com/mathlorgues/math1sd1516/blob/master/20150907/cahier.pdf}
      {devoir à la maison} pour lundi 14  septembre 2015.  
    \end{itemize}
    
    Mardi 8 septembre 2015
    \begin{itemize}   
      
      \item Discriminant, racines d'un trinômes et factorisations.
      
      \item Résolution d'une équation du second degré.
      
    \end{itemize}
    
    Jeudi 10 septembre 2015 Groupes exercices.
    \begin{itemize}   
      \item Résolution d'équations du second degré exigibles en classe de seconde.  
      \item  Résolution d'une équation du second degré.
      \item  Factorisation de trinôme du second degré.
    ...
    \begin{itemize}
      \item \'Etude du signe d'un trinôme du second degré.
      
      \item \'Equations du second degré avec un paramètre.
      
      \item Exercices sur les trinômes à faire de tête.
