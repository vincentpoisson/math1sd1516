...
\fancyhead[C]{ Activité n° 1 Extremums}
...
\begin{document}
  ...
  Pour chacune des fonctions suivantes, déterminer les éventuels extremums:
  
   \vspace{1cm}
  \begin{center}
    \begin{tikzpicture}
      \tkzTabInit{x/1,a(x)/2}{0, 1, 10}
      \tkzTabVar{+/1,-/-1,+/3}
    \end{tikzpicture}
  ...
  \begin{center}
    \begin{tikzpicture}
      \tkzTabInit{x/1,b(x)/2}{-2, 0, 7}	
      \tkzTabVar{-/1,+/5,-/3}
    \end{tikzpicture}
  \end{center}
  \begin{center}
    \begin{tikzpicture}
      \tkzTabInit{x/1,c(x)/2}{$-\infty$, -1, $+\infty$}	
      \tkzTabVar{-/1,+/6,-/3}
    \end{tikzpicture}
  \end{center}
  \begin{center}
    \begin{tikzpicture}
      \tkzTabInit{x/1,d(x)/2}{$-\infty$, 3, $+\infty$}	
