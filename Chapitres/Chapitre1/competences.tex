...
\begin{document}
  ...
  \begin{enumerate}
     \item Réaliser le tableau de variations d'un trinôme.
     $\to$ une méthode: appliquer le théorème correspondant. 
     \item Calculer les coordonnées du sommet d'une parabole.
     \item Mettre un trinôme sous la forme développée réduite.
     \item Trouver le nombre de racines d'un trinôme.
     \item Calculer ces racines d'un trinôme.
     \item Mettre sous forme factorisée.
     \item Résoudre une équation du second degré.
     \item Résoudre une inéquation du second degré.
     \item Mettre un trinôme sous forme factorisée.
     \item Mettre un trinôme sous forme canonique.
  \end{enumerate}
